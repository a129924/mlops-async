...
- [X] 5. Record TDD verdict and requirement-to-test mapping in `plan/request-header-policy-normalization/request-header-policy-normalization.tdd-test-authoring.yaml`, confirming production code is still unmodified when RED tests are introduced.
