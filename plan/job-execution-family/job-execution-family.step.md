...
- [X] Gate 3 — 完成 `test_value_objects.py` 的 Job / JobState semantic parsing and error-boundary tests。
- [X] Gate 4 — 完成 `test_client.py` 的 request construction, one-await, propagation, and cancellation tests。
